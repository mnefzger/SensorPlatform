...
import au.carrsq.sensorplatformshared.BluetoothListener;
import au.carrsq.sensorplatformshared.InteractionEvents;
import au.carrsq.sensorplatformshared.InteractionObject;
    ...
    private class AcceptThread extends Thread {
        ...
        private void sendStop() {
            if(socket != null && socket.isConnected())
                sendDataToPairedDevice("au.carrsq.sensorplatform.STOP");
            else
